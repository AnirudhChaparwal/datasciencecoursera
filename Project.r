...
Newds1<-DataSet[,c(1,2,3,4,5,43,44,45,83,84,85,123,124,125,163,164,165,203,216,229,242,255,268,269,270,347,348,349,426,427,428,505,518,531,544)]

write.table(Newds1,file="Tidy_Data_Set.txt",row.names=FALSE)